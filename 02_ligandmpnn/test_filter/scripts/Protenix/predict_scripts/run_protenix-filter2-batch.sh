...
for pdb in $(cat /home/junjiechen/1_work/250401-Dpepalign/Benchmark-Filter/datasets/PepSet_3per_length/PDB.list); do
    ...
    CUDA_VISIBLE_DEVICES=0 protenix predict --input pred_filter2.json --out_dir ./predict_output-filter2 --use_msa true --seeds 42,43,44 > protenix_predict-filter2.log 2>&1
