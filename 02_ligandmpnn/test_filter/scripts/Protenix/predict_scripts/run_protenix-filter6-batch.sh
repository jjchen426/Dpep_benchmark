...
for pdb in $(cat /home/junjiechen/1_work/250401-Dpepalign/Benchmark-Filter/datasets/PepSet_3per_length/PDB.list); do
    ...
    CUDA_VISIBLE_DEVICES=0 protenix predict --input pred_filter6.json --out_dir ./predict_output-filter6 --use_msa true --seeds 42,43,44 > protenix_predict-filter6.log 2>&1
